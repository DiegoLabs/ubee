  ...
  if (in_array($command, $allowedCommands)) {
    switch ($command) {
      ...
      case 'whois':
        ...
        break;
      case 'youtube':
        $reply = 'Youtube link: https://youtube.com/phpugly';
        break;
      default:
        $reply .= commandHelp();
    }
...
function commandHelp()
{
  ...
  $reply .= "!youtube Get the link to the PHPUgly Youtube channel \r\n";
  return $reply;
}
...
function commandWhois($message)
{
  ...
  if (in_array($name, ['eric', 'erick', 'erik', 'shocm'])) {
    $reply = 'The host of the show. Mastodon: https://phparch.social/@eric | Twitter: https://twitter.com/shocm';
  }
